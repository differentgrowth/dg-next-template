  ...
  return (
    <Example className="items-center justify-center" title="Card">
      <Card className="relative w-full max-w-sm overflow-hidden pt-0">
        ...
        {/* biome-ignore lint/performance/noImgElement: Using img for external URL */}
        {/* biome-ignore lint/correctness/useImageSize: Dimensions controlled by CSS aspect-video */}
        <img
          alt="Abstract shapes by mymind on Unsplash"
